            ...
            <div className="p-4 px-6 border-t border-slate-200 bg-slate-50 flex justify-between items-center">
              <button
                ...
                onClick={() => {
                  ...
                  doc.write(html);
                  doc.close();
                  iframe.onload = () => setTimeout(() => { iframe.contentWindow!.focus(); iframe.contentWindow!.print(); document.body.removeChild(iframe); }, 400);
                  setTimeout(() => { iframe.contentWindow!.focus(); iframe.contentWindow!.print(); document.body.removeChild(iframe); }, 800);
                }}
